---
title: "データasプロダクトにおけるdbtモデルバージョン設計"
emoji: "🔄"
...
ナウキャストでは、snowflake×dbtを中心にデータ基盤が構築されており、各種プロダクトからデータが呼び出されています。まさに、"**データasプロダクト**"です
...
- モデルの差分調査がしやすい。
  ...
  - バージョンをわけておけば、v1とv2の２つのテーブル差分調査となるので、やりやすい。
